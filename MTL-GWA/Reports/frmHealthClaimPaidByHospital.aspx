<%@ Page Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmHealthClaimPaidByHospital.aspx.vb" Inherits="Reports_frmHealthClaimPaidByHospital" title="รายงานการจ่ายค่าสินไหมตามโรงพยาบาล(Health Claim by Hospital)" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script language="javascript" type="text/javascript" >
        function PrintReport() {
            if (Valid() == true) {
                var ReportName = 'rptHltClmByHospital';
