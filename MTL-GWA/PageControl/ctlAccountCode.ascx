<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlAccountCode.ascx.vb" Inherits="PageControl_ctlAccountCode" %>
            ...
            <td colspan="2">
                ...
                Width="100%" PageSize="10" >
                    ...
                    <Columns> 
                        ...
                        <asp:TemplateField HeaderText="รหัสบริษัท" SortExpression="ac_code" >
                            <HeaderStyle Width="100px" HorizontalAlign="Center" />
                            <ItemStyle Width="100px" HorizontalAlign="Center" />
                            <ItemTemplate >
                                <asp:LinkButton ID="lnkAcCode" OnClick="GetAccountDetail" runat="server" Text="<%# Bind('ac_code') %>" CommandArgument="<%# Bind('ac_code') %>" ></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="ชื่อบริษัท" SortExpression="ac_name" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Left" />
                            <ItemTemplate >
                                <asp:LinkButton ID="lnkAccountName" OnClick="GetAccountDetail" runat="server" Text="<%# Bind('ac_name') %>" CommandArgument="<%# Bind('ac_code') %>" ></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
