<%@ Control Language="VB" AutoEventWireup="false" CodeFile="incHealth.ascx.vb" Inherits="PageControl_incHealth" %>
    ...
    <table id="Table1" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff"
        ...
        <tr>
            <td colspan="2" align="left">
                &nbsp;&nbsp;&nbsp;
                <b><asp:Label ID="lblTitle" runat="server" Text="การประกันสุขภาพ" /></b>
            </td>
        </tr>
        <tr>
            <td colspan="2" valign="top" align="center" >
                <div style="width:90%;height:300px;border-style:solid;border-width:1px;overflow:scroll;overflow-x: hidden;">
                    <table border="0"  cellpadding="0" cellspacing="0" width="95%"  >
                        <asp:Label ID="lblHealthDesc" runat="server"></asp:Label>
        ...
        <tr>
            <td align="left" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                Remark : Please learn more details in the policy.
            </td>
        </tr>
        <tr>
            <td colspan="2">&nbsp;</td>
