<%@ Control Language="VB" AutoEventWireup="false" CodeFile="incTPI.ascx.vb" Inherits="PageControl_incTPI" %>
    ...
    <table id="Table1" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff"
        ...
        <tr>
            <td colspan="2" align="left">
                &nbsp;&nbsp;&nbsp;
                <b><asp:Label ID="lblTitle" runat="server" Text="การประกันทุพพลภาพ" /></b>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <table border="0"  cellpadding="0" cellspacing="0" width="95%" align="center" style="border-style: solid; border-width: 1px;">
                    ...
                    <tr>
                        <td width="80%" align="left" >- คุ้มครองการทุพพลภาพสิ้นเชิงเนื่องจากการเจ็บป่วย หรืออุบัติเหตุ</td>
                        <td width="20%" align="left" >100% ของทุนประกัน</td>
                    </tr>
                    <tr><td colspan="2">&nbsp;</td></tr>
                </table>
            </td>
