Namespace CallWS
    Public Class InputInsertUserProfilePara
        ...
        Dim _p_in_is_first_login As String = ""
        Dim _p_in_login_fail_count As String = ""
        Dim _p_in_input_person As String = ""
        Dim _p_in_create_dttm As String = ""
        ...
        Public Property IS_FIRST_LOGIN() As String
            Get
                Return _p_in_is_first_login
            End Get
            Set(ByVal value As String)
                _p_in_is_first_login = value
            End Set
        End Property
        Public Property LOGIN_FAIL_COUNT() As String
            Get
                Return _p_in_login_fail_count
            End Get
            Set(ByVal value As String)
                _p_in_login_fail_count = value
            End Set
        End Property
        ...
        Public Property CREATE_DTTM() As String
            Get
                Return _p_in_create_dttm
            End Get
            Set(ByVal value As String)
                _p_in_create_dttm = value
            End Set
        End Property
