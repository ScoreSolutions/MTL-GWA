Namespace OutputWS
    Public Class OutputGetBenefitHealthDentalPara
        ...
        Public Property BENEFIT_LIST() As DataTable
            ...
            End Set
        End Property
        Public Property ISFOUND_DENTAL() As String
            Get
                Return _isFound_dental
            End Get
            Set(ByVal value As String)
                _isFound_dental = value
            End Set
        End Property
    End Class
End Namespace
