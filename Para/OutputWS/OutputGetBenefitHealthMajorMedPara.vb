Namespace OutputWS
    Public Class OutputGetBenefitHealthMajorMedPara
        ...
        Public Property BENEFIT_LIST() As DataTable
            ...
            End Set
        End Property
        Public Property ISFOUND_MAJOR() As String
            Get
                Return _isFound_major
            End Get
            Set(ByVal value As String)
                _isFound_major = value
            End Set
        End Property
    End Class
End Namespace
