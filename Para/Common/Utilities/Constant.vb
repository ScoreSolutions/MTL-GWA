Namespace Common.Utilities
    Public Class Constant
        ...
        Partial Public Class AccountStatus
            Public Const INPROGRESS_TH As String = "อยู่ระหว่างการดำเนินการ"
            Public Const INPROGRESS_EN As String = "In Process"
            Public Const POLICY_EXPIRED_TH As String = "กรมธรรม์สิ้นสุดความคุ้มครอง"
            Public Const POLICY_EXPIRED_EN As String = "Policy Expired"
        End Class
