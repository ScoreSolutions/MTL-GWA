...
Namespace TABLE
    'Represents a transaction for LOG_TRANS table LinqDB.
    '[Create by  on November, 20 2011]
    Public Class LogTransLinqDB
        Public sub LogTransLinqDB()
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Long, trans As SQLTransaction) As LogTransLinqDB
        ...
        '/// Returns an indication whether the record of LOG_TRANS by specified LOGIN_HIS_ID key is retrieved successfully.
        '/// <param name=cLOGIN_HIS_ID>The LOGIN_HIS_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByLOGIN_HIS_ID(cLOGIN_HIS_ID As Long, trans As SQLTransaction) As Boolean
            Return doChkData("LOGIN_HIS_ID = " & DB.SetDouble(cLOGIN_HIS_ID) & " ", trans)
        End Function

        '/// Returns an duplicate data record of LOG_TRANS by specified LOGIN_HIS_ID key is retrieved successfully.
        '/// <param name=cLOGIN_HIS_ID>The LOGIN_HIS_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByLOGIN_HIS_ID(cLOGIN_HIS_ID As Long, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("LOGIN_HIS_ID = " & DB.SetDouble(cLOGIN_HIS_ID) & " " & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As LogTransLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
