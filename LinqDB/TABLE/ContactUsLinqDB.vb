...
Namespace TABLE
    'Represents a transaction for CONTACT_US table LinqDB.
    '[Create by  on November, 20 2011]
    Public Class ContactUsLinqDB
        Public sub ContactUsLinqDB()

        End Sub 
        ' CONTACT_US
        Const _tableName As String = "CONTACT_US"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into CONTACT_US table successfully.
        ...
        '/// Returns an indication whether the current data is updated to CONTACT_US table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from CONTACT_US table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of CONTACT_US by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of CONTACT_US by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Long, trans As SQLTransaction) As ContactUsLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of CONTACT_US by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Long, trans As SQLTransaction) As ContactUsPara
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of CONTACT_US by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("reply_mail")) = False Then _REPLY_MAIL = Rdr("reply_mail").ToString()
                        If Convert.IsDBNull(Rdr("send_type")) = False Then _SEND_TYPE = Rdr("send_type").ToString()
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As ContactUsLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of CONTACT_US by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As ContactUsPara
            ClearData()
            _haveData  = False
            Dim ret As New ContactUsPara
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("reply_mail")) = False Then ret.REPLY_MAIL = Rdr("reply_mail").ToString()
                        If Convert.IsDBNull(Rdr("send_type")) = False Then _SEND_TYPE = Rdr("send_type").ToString()
        ...
        'Get Insert Statement for table CONTACT_US
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & TableName & " (ID, CREATE_BY, CREATE_ON, UPDATE_BY, UPDATE_ON, MENU_ID, ACCOUNT_CODE, DESCRIPTION, REPLY_MAIL, SEND_TYPE)"
                Sql += " VALUES("
                ...
                Sql += DB.SetString(_REPLY_MAIL) & ", "
                Sql += DB.SetString(_SEND_TYPE)
                sql += ")"
                Return sql
            End Get
        End Property
        ...
        'Get update statement form table CONTACT_US
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "REPLY_MAIL = " & DB.SetString(_REPLY_MAIL) & ", "
                Sql += "SEND_TYPE = " & DB.SetString(_SEND_TYPE)
                Return Sql
            End Get
        End Property


        'Get Delete Record in table CONTACT_US
        ...
        'Get Select Statement for table CONTACT_US
